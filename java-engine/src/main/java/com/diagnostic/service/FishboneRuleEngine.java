...
public class FishboneRuleEngine {
    ...
    public List<String> infer(DiagnosticRequest req, double Re, double deltaP, double h) {
        ...
        List<Rule> rules = List.of(
            ...
            new Rule(() -> req.fluidProperties != null && req.fluidProperties.consistencyIndexK != null && req.fluidProperties.flowBehaviorIndexN != null && req.fluidProperties.flowBehaviorIndexN < 1.0,
                     "[Material] Non-Newtonian shear-thinning behaviour detected — consider shear-dependent viscosity in calculations")
        );
